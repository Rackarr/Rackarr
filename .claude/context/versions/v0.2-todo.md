...
# Rackarr v0.2 — Implementation Checklist (Revised)
...
- [x] **P01 (getScreenCTM coordinates):** Complete — `src/lib/utils/coordinates.ts` exists
...
### Prompt 1.1 — Migrate Drag-Drop to screenToSVG ✅
...
### Prompt 1.2 — Install and Configure panzoom ✅
...
### Prompt 1.3 — Integrate panzoom into Canvas ✅
...
### Prompt 1.4 — Verify Drag-Drop with panzoom (CRITICAL GATE) ✅
...
- [x] Create IconFitAll.svelte
- [x] Add Fit All button to Toolbar
- [x] Write Toolbar button tests
- [x] Implement fitAll() function
- [x] Wire button to fitAll()
- [x] Add keyboard shortcut 'F'
- [x] Write keyboard shortcut test
- [x] Handle prefers-reduced-motion (instant vs animated)
- [x] All tests pass (708 total)
- [x] **Commit:** `feat(canvas): add Fit All zoom button`

**Note:** Commit ada0881. Added IconFitAll.svelte, added button to Toolbar, added F shortcut to KeyboardHandler, implemented fitAll() in canvas store using racksToPositions() helper.
...
- [x] Write type tests for RackView
- [x] Write type tests for DeviceFace
- [x] Write tests for default values
- [x] Add RackView type to index.ts
- [x] Add DeviceFace type to index.ts
- [x] Add view property to Rack interface
- [x] Add face property to PlacedDevice interface
- [x] Add DEFAULT_RACK_VIEW constant
- [x] Add DEFAULT_DEVICE_FACE constant
- [x] All tests pass (715 total)
- [x] **Commit:** `feat(types): add rear view type definitions`

**Note:** Commit 9c826ad. Also updated createRack() and placeDevice() to use new defaults.
...
### Prompt 2.5 — Integrate View Toggle into Rack
...
| ----------------------- | ------- | ----------- |
| Pre-requisite (P01)     | —       | ✅ Complete |
| 1. Technical Foundation | 1.1-1.6 | 6/6 ✅      |
| 2. Core Features        | 2.1-2.8 | 1/8 🟡      |
| 3. UI Polish            | 3.1-3.5 | 0/5 ⬜      |
| 4. Data & Migration     | 4.1-4.4 | 0/4 ⬜      |
| **TOTAL**               | **23**  | **8/23**    |
