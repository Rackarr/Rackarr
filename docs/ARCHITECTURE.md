# Rackarr Architecture Guide

## Overview

Rackarr is a browser-based rack layout designer for homelabbers. It runs entirely client-side with no backend required, making it lightweight, portable, and privacy-friendly.

### Design Principles

- **ADHD-friendly**: Minimal decision points, focused workflows
- **Lightweight**: Static frontend, no backend dependencies
- **Portable**: Self-contained `.rackarr.zip` archives with embedded images
