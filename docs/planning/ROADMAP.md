...
Strategic vision and version philosophy. For active work items, see [GitHub Issues](https://github.com/Rackarr/Rackarr/issues).

---

## Vision

Rackarr is a lightweight, FOSS, web-based rack layout designer for homelabbers. It prioritises:
...
See [GitHub Milestones](https://github.com/Rackarr/Rackarr/milestones) for version-specific work items.
...
See [GitHub Issues](https://github.com/Rackarr/Rackarr/issues) for ways to contribute:
...
_This document defines product vision. For active work items, see [GitHub Issues](https://github.com/Rackarr/Rackarr/issues)._
